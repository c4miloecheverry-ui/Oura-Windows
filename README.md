...
> **Windows SmartScreen warning** (Windows)
...
> [!NOTE]
> On Windows, run the build command from an **Administrator** terminal to avoid symlink permission errors during the electron-builder packaging step.
